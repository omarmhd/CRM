        ...
        <div class="card-body py-1">
            ...
            <!--begin::Input group-->
                ...
                <div class="text-center mt-20 ms-20 mb-20">
                    ...
                    <a href="{{route("users.index")}}" class="btn btn-white me-3">إلغاء</a>
...
@endsection
@push('js')
    @include("parts.sweetCreate", ['route' => route('users.update',['user' => $user]),'method'=>'put','redirect'=>route('users.index')])
