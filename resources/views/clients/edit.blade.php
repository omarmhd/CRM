        ...
        <div class="card-body py-1">
            ...
            <!--begin::Input group-->
                ...
                <div class="text-center mt-20 ms-20 mb-20">
                    ...
                    <a href="{{route("clients.index")}}" class="btn btn-white me-3"> <i class="fa fa-"></i>إلغاء</a>
                </div>
                <!--end::Actions-->
            </form>
            <!--end:Form-->
...
@endsection
@push('js')
    @include("parts.sweetCreate", ['route' => route('clients.update',['client' => $client]),'method'=>'put','redirect'=>route('clients.index')])
@endpush
